    ...
    <div class="container-fluid">
        <div class="row">
            <nav class="col-md-2 d-none d-md-block pt-3 bg-sidebar sidebar px-0">
                ...
                <a class="text-decoration-none d-block py-1 px-2 mt-1" href="<?= url('admin/article') ?>"><i class="fas fa-newspaper"></i> Post</a>
                ...
                <a class="text-decoration-none d-block py-1 px-2 mt-1" href="<?= url('admin/message') ?>"><i class=" fas fa-tools"></i> Message</a>
            </nav>
