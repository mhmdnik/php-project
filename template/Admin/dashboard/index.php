...
<div class="row mt-3">
    ...
    <div class="col-sm-6 col-lg-3">
        <a href="<?= url('admin/article') ?>" class="text-decoration-none">
            <div class="card text-white bg-dracula mb-3">
                <div class="card-header d-flex justify-content-between align-items-center"><span><i class="fas fa-newspaper"></i> Article</span> <?= $articleCount["COUNT(*)"] ?> <span class="badge badge-pill right"></span></div>
                <div class="card-body">
                    <section class="d-flex justify-content-between align-items-center font-12">
                        <span class=""><i class="fas fa-bolt"></i> Views <span class="badge badge-pill mx-1">  <?= $articleView["SUM(view)"] ?> </span></span>
                    </section>
                </div>
            </div>
        </a>
        ...
        <div class="table-responsive">
            <table class="table table-striped table-sm">
                ...
                <tbody>
                    ...
                    <?php foreach($mostViewedArticles as $mostViewedArticle) {?>
                        <tr>
                            <td>
                              <?=   $mostViewedArticle['id'] ?>
                            </td>
                            <td>
                            <?= $mostViewedArticle['title'] ?>
                            </td>
                            <td><span class="badge badge-secondary"><?= $mostViewedArticle['view'] ?></span></td>
                        </tr>
    ...
    <div class="col-4">
        ...
        <div class="table-responsive">
            <table class="table table-striped table-sm">
                ...
                <?php foreach($mostCommentedArticles as $mostCommentedArticle) {?>

                    <tr>
                        <td>
                            <a class="text-primary" href="">
                           <?= $mostCommentedArticle['id'] ?>
                            </a>
                        </td>
                        <td>
                      <?=  $mostCommentedArticle['title'] ?>
                        </td>
                        <td><span class="badge badge-success"><?= $mostCommentedArticle['comment_count'] ?></span></td>
                    </tr>
                    <?php } ?>
